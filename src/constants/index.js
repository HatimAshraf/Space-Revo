...
export const REVIEWS = {
  text: 'Hear what our clients have to say about their experiences with Space-Revo. We take pride in our work and are committed to delivering top-notch home renovation services.',
  reviews: [
    {
      name: 'Alice Johnson',
      title: 'Homeowner',
      review:
        "Space-Revo transformed our outdated kitchen into a modern masterpiece. The team was professional, attentive to our needs, and delivered beyond our expectations. We couldn't be happier with the results!",
      image: user1,
    },
    {
      name: 'Bob Smith',
      title: 'Homeowner',
      review:
        'Our bathroom renovation was seamless, thanks to Space-Revo. They took care of everything from design to execution, and the attention to detail was impeccable. Highly recommended!',
      image: user2,
    },
    {
      name: 'Carla Mendes',
      title: 'Homeowner',
      review:
        "Space-Revo helped us create the perfect outdoor living space. Their creativity and craftsmanship turned our backyard into a beautiful oasis. It's now our favorite place to relax and entertain guests.",
      image: user3,
    },
    {
      name: 'David Lee',
      title: 'Homeowner',
      review:
        "The living room update exceeded our expectations. Space-Revo's team was skilled and communicative, ensuring a smooth renovation process. The new design has brought a fresh, modern look to our home.",
      image: user4,
    },
    {
      name: 'Ella Fernandez',
      title: 'Homeowner',
      review:
        'From start to finish, Space-Revo was a pleasure to work with. They listened to our vision and brought it to life with expert craftsmanship. Our home office is now a stylish and functional space.',
      image: user5,
    },
    {
      name: 'Frank Wilson',
      title: 'Homeowner',
      review:
        'Space-Revo did an amazing job on our basement conversion. They created a cozy, multi-functional space that our family loves. The team was professional and delivered on time and within budget.',
      image: user6,
    },
  ],
};
